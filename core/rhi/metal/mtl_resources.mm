...
BufferResult MetalDevice::create_buffer(const BufferDesc& desc,
    ...
    return guarded<BufferResult>("create_buffer", [&]() -> BufferResult {
...
SamplerResult MetalDevice::create_sampler(const SamplerDesc& desc) {
    return guarded<SamplerResult>("create_sampler", [&]() -> SamplerResult {
...
ShaderResult MetalDevice::create_shader(const ShaderDesc& desc) {
    return guarded<ShaderResult>("create_shader", [&]() -> ShaderResult {
...
PipelineResult MetalDevice::create_pipeline(const PipelineDesc& desc) {
    return guarded<PipelineResult>("create_pipeline", [&]() -> PipelineResult {
        ...
        entry.pipeline = [device_ newRenderPipelineStateWithDescriptor:pipeline_desc
                                                                 error:&ns_error];

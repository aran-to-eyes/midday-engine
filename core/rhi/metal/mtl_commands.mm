...
std::optional<base::Error> MetalDevice::destroy_command_list(CommandListHandle handle) {
    return guarded_call("destroy_command_list", [&]() -> std::optional<base::Error> {
...
std::optional<base::Error> MetalDevice::cmd_begin(CommandListHandle list) {
    return guarded_call("cmd_begin", [&]() -> std::optional<base::Error> {
        std::optional<base::Error> error;
...
std::optional<base::Error> MetalDevice::cmd_begin_render_pass(CommandListHandle list,
    ...
    return guarded_call("cmd_begin_render_pass", [&]() -> std::optional<base::Error> {
        std::optional<base::Error> error;
        CommandListEntry* entry = live_list(list, error);
        if (entry == nullptr)
            return error;
...
std::optional<base::Error> MetalDevice::cmd_bind_pipeline(CommandListHandle list,
    ...
    return guarded_call("cmd_bind_pipeline", [&]() -> std::optional<base::Error> {
        std::optional<base::Error> error;
        CommandListEntry* entry = live_list(list, error);
        if (entry == nullptr)
            return error;
...
std::optional<base::Error> MetalDevice::cmd_bind_vertex_buffer(CommandListHandle list,
                                                               BufferHandle buffer) {
    return guarded_call("cmd_bind_vertex_buffer", [&]() -> std::optional<base::Error> {
        std::optional<base::Error> error;
        CommandListEntry* entry = live_list(list, error);
        if (entry == nullptr)
            return error;
...
std::optional<base::Error> MetalDevice::cmd_bind_texture(CommandListHandle list,
    ...
    return guarded_call("cmd_bind_texture", [&]() -> std::optional<base::Error> {
        std::optional<base::Error> error;
        CommandListEntry* entry = live_list(list, error);
        if (entry == nullptr)
            return error;
...
std::optional<base::Error> MetalDevice::cmd_draw(CommandListHandle list,
    ...
    return guarded_call("cmd_draw", [&]() -> std::optional<base::Error> {
        std::optional<base::Error> error;
        CommandListEntry* entry = live_list(list, error);
        if (entry == nullptr)
            return error;
...
std::optional<base::Error> MetalDevice::cmd_end_render_pass(CommandListHandle list) {
    return guarded_call("cmd_end_render_pass", [&]() -> std::optional<base::Error> {
        std::optional<base::Error> error;
        CommandListEntry* entry = live_list(list, error);
        if (entry == nullptr)
            return error;
...
std::optional<base::Error> MetalDevice::submit_and_wait(CommandListHandle list) {
    return guarded_call("submit_and_wait", [&]() -> std::optional<base::Error> {
        std::optional<base::Error> error;
        CommandListEntry* entry = live_list(list, error);
        if (entry == nullptr)
            return error;

...
- api_compat_hash: `412c76eca6ae00e2`
...
| `--components` | `string` | no |  | a project component-schema manifest (`midday script extract --out`) naming the scene's TS components |

// engine.d.ts -- GENERATED by tools/codegen_bootstrap from engine_api.json. DO NOT EDIT.
// engine_version 0.1.0, api_compat_hash 12b06cedac83d2ab (signatures only; docs excluded).
...
declare namespace midday {
    ...
    interface ApiVerbArgs {
        ...
        /** dump | diff */
        action: string;
        /** diff: baseline engine_api.json to compare against */
        old?: string;
    }
